...
def test_check_for_privileges_list(open_connection):
    ...
    lackey.click("text_ALL_LANGS.png")
    lackey.click("text_DELETE_EMPLOYEE.png")
    lackey.click("text_DEPT_BUDGET.png")
    lackey.click("text_GET_EMP_PROJ.png")
    lackey.click("text_MAIL_LABEL.png")
    lackey.click("text_ORG_CHART.png")
    lackey.click("text_SHIP_ORDER.png")
    lackey.click("text_SHOW_LANGS.png")
    lackey.click("text_SUB_TOT_BUDGET.png")
    lackey.click("text_Procedures.png")
